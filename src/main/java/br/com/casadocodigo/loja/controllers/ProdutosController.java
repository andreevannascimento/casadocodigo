...
public class ProdutosController {
    ...
    public ModelAndView gravar(final MultipartFile sumario, @Valid final Produto produto, final BindingResult result,
        ...
        final String path = this.fileSaver.write("arquivos-sumario", sumario);
    ...
    public ModelAndView listar() {
        ...
        final List<Produto> produtos = this.dao.listar();
